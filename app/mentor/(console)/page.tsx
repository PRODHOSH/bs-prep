...
import { ExternalLink, BookOpen, LifeBuoy, Mail, MessageCircle } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-emerald-500/30 bg-[#102329] p-6 shadow-lg relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-400 px-6 py-3 text-xs font-bold uppercase tracking-wider text-[#061418] transition-all hover:bg-emerald-300 shadow-md shrink-0"
        >
      ...
      <section className="rounded-2xl border border-white/10 bg-[#0e1f24] p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0 w-full md:w-auto">
          <div className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#152a33] border border-white/10 px-4 py-2.5 text-xs font-semibold text-emerald-100">
            <MessageCircle className="w-4 h-4 text-emerald-400" />
            <span>Msg in Mentor Group</span>
          </div>
          <a
            href="mailto:support@bsprep.in"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#152a33] border border-white/10 px-4 py-2.5 text-xs font-semibold text-emerald-100 hover:bg-white/10 transition-colors"
          >
