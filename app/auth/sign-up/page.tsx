    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-lg">Join the IITM BS community.</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Select value={role} onValueChange={setRole}>
              <SelectTrigger className="h-14 text-base bg-transparent border border-slate-700 text-white focus:border-slate-600 focus:ring-0">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-start space-x-3 p-4 bg-slate-900/30 rounded-lg border border-slate-700">
            <Checkbox
              id="terms"
        ...
        <div className="text-center mt-8">
          <p className="text-slate-400">
            ...
            <Link href="/auth/login" className="text-slate-300 font-semibold hover:text-white transition-colors underline">
              Login
            </Link>
          </p>
        </div>
