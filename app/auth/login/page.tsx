    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-lg">Enter your coordinates.</p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-slate-400">
            Need an account?{" "}
            <Link href="/auth/sign-up" className="text-slate-300 font-semibold hover:text-white transition-colors underline">
              Register
            </Link>
          </p>
        </div>
