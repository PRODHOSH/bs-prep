      ...
      <main className="flex-1 flex items-center justify-center py-20 px-4">
        <div className="max-w-xl w-full text-center space-y-6">
          ...
          <p className="text-base text-black/70 max-w-md mx-auto">
            We're building a Python compiler with NumPy & Pandas support that runs entirely in your browser. Stay tuned!
          </p>
          ...
          <div className="pt-4">
            <Link href={isAuthenticated ? "/dashboard" : "/courses"}>
              <Button variant="outline" className="group border-slate-300 hover:border-slate-900 text-black hover:bg-transparent hover:text-black">
                {isAuthenticated ? "Back to Dashboard" : "Explore Courses"}
